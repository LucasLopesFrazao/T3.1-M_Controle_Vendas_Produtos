...
public class RealizarVenda extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        RealizarVendaInputCodProduto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RealizarVendaInputCodProdutoActionPerformed(evt);
            }
        });

        RealizarVendaInputNomeProduto.setEditable(false);
        RealizarVendaInputNomeProduto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RealizarVendaInputNomeProdutoActionPerformed(evt);
            }
        });

        RealizarVendaInputPrecoProduto.setEditable(false);
        RealizarVendaInputPrecoProduto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RealizarVendaInputPrecoProdutoActionPerformed(evt);
            }
        });

        RealizarVendaInputQtdProduto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RealizarVendaInputQtdProdutoActionPerformed(evt);
            }
        });
        ...
        RealizarVendaInputNomeVendedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RealizarVendaInputNomeVendedorActionPerformed(evt);
            }
        });
        ...
        RealizarVendaInputNomeCliente.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RealizarVendaInputNomeClienteActionPerformed(evt);
            }
        });
    ...
    private void RealizarVendaBtnPesquisarClienteActionPerformed(java.awt.event.ActionEvent evt) {                                                                 
        Cliente c = controleCliente.pesquisarCliente(RealizarVendaInputCPF.getText());  
        String nome = c.getNome();
        RealizarVendaInputNomeCliente.setText(nome);
    }                                                                

    private void RealizarVendaBtnPesquisarVendedorActionPerformed(java.awt.event.ActionEvent evt) {                                                                  
        Vendedor v = controleVendedor.pesquisarPorNome(RealizarVendaInputNomeVendedor.getText()); 
        String nome = v.getNome();
        RealizarVendaInputNomeVendedor.setText(nome);
    }                                                                 
    ...
    private void RealizarVendaBtnRealizarVendaActionPerformed(java.awt.event.ActionEvent evt) { 
    	...
    	controleVendas.adicionarVenda(new Venda(
    			controleVendas.codigoUltimoVendaCadastrada() + 1, 
    			new Date(), 
    			controleVendas.totalVenda(pedidos), 
    			controleVendedor.pesquisarPorNome(RealizarVendaInputNomeVendedor.getText()), 
    			controleCliente.pesquisarCliente(RealizarVendaInputCPF.getText()), 
    			pedidos));
    	dispose();
    }                                                             
    ...
    private void RealizarVendaInputNomeVendedorActionPerformed(java.awt.event.ActionEvent evt) {                                                               
        // TODO add your handling code here:
    }                                                              

    private void RealizarVendaInputCodProdutoActionPerformed(java.awt.event.ActionEvent evt) {                                                             
        // TODO add your handling code here:
    }                                                            

    private void RealizarVendaInputNomeProdutoActionPerformed(java.awt.event.ActionEvent evt) {                                                              
        // TODO add your handling code here:
    }                                                             

    private void RealizarVendaInputPrecoProdutoActionPerformed(java.awt.event.ActionEvent evt) {                                                               
        // TODO add your handling code here:
    }                                                              

    private void RealizarVendaInputQtdProdutoActionPerformed(java.awt.event.ActionEvent evt) {                                                             
        // TODO add your handling code here:
    }                                                            
