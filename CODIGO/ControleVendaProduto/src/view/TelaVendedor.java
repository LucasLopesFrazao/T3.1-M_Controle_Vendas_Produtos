...
public class TelaVendedor extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        controleFuncionarioBtnApagarCampos.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        controleFuncionarioBtnSalvar.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        controleFuncionarioDadosPessoais.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Dados pessoais", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 18))); // NOI18N

        controleFuncionarioInputEmail.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                controleFuncionarioInputEmailActionPerformed(evt);
            }
        });
        ...
        controleFuncionarioBtnExcluir.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        controleFuncionarioBtnEditar.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        controleFuncionarioBtnPesquisar.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
    ...
    private void controleFuncionarioBtnSalvarActionPerformed(java.awt.event.ActionEvent evt) {                                                             
    	...
    	if(controleVendedor.checarId(cod)) { // CHECANDO SE JÁ EXISTE
    ...
    private void controleFuncionarioBtnListarTodosActionPerformed(java.awt.event.ActionEvent evt) {                                                                  
        DefaultTableModel tabelaVendedores = (DefaultTableModel) controleFuncionarioTblFuncionarios.getModel();
    	List<Vendedor> todosVendedores = controleVendedor.obterTodosVendedores();
