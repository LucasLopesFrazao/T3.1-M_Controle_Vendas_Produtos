    ...
    private void controleClienteBtnSalvarActionPerformed(java.awt.event.ActionEvent evt) {                                                         
       //PEGANDO INFORMAÇÕES
    	...
    	if(bancoDadosCliente.checarId(novoCodigoCliente)) { // CHECANDO SE JÁ EXISTE
    		bancoDadosCliente.editarCliente(new Cliente(novoCodigoCliente, nomeCliente, emailCliente, cpf, cepCliente, cidadeCliente, enderecoCliente, numeroCliente, bairroCliente, ufCliente));
    	}else {
    		bancoDadosCliente.adicionarCliente(new Cliente(novoCodigoCliente, nomeCliente, emailCliente, cpf, cepCliente, cidadeCliente, enderecoCliente, numeroCliente, bairroCliente, ufCliente));
    	}
