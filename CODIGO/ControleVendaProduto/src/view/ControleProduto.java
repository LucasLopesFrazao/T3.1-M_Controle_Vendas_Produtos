...
public class ControleProduto extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        controleProdutoInputNome = new javax.swing.JFormattedTextField();
        jLabel13 = new javax.swing.JLabel();
        controleProdutoInputEstoque = new javax.swing.JFormattedTextField();
        controleProdutoInputPreco = new javax.swing.JFormattedTextField();
        ...
        controleProdutoInputPesquisarNome = new javax.swing.JFormattedTextField();
        ...
        try {
            controleProdutoInputNome.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("????????????????????????????????????????????????????????????????????????????????????????????????????")));
        ...
        try {
            controleProdutoInputEstoque.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }

        try {
            controleProdutoInputPreco.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("#######")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        ...
        controleProdutoDadosPessoaisLayout.setHorizontalGroup(
            ...
            .addGroup(controleProdutoDadosPessoaisLayout.createSequentialGroup()
                ...
                .addGroup(controleProdutoDadosPessoaisLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(controleProdutoInputCod)
                    .addComponent(controleProdutoInputNome, javax.swing.GroupLayout.DEFAULT_SIZE, 314, Short.MAX_VALUE))
        ...
        controleProdutoTblProdutos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "Preço (R$)", "Em estoque"
            }
        ));
        ...
        try {
            controleProdutoInputPesquisarNome.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("????????????????????????????????????????????????????????????????????????????????????????????????????")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
            ...
            .addGroup(controleProdutoConsultarLayout.createSequentialGroup()
                .addGroup(controleProdutoConsultarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(controleProdutoConsultarLayout.createSequentialGroup()
                        ...
                        .addComponent(controleProdutoInputPesquisarNome, javax.swing.GroupLayout.PREFERRED_SIZE, 336, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private javax.swing.JFormattedTextField controleProdutoInputEstoque;
    private javax.swing.JFormattedTextField controleProdutoInputNome;
    private javax.swing.JFormattedTextField controleProdutoInputPesquisarNome;
    private javax.swing.JFormattedTextField controleProdutoInputPreco;
